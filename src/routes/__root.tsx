...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An intimate, cinematic love poem rendered as a private universe made for one." },
      { name: "author", content: "For you" },
      { name: "theme-color", content: "#0a0a1a" },
      { property: "og:title", content: "Am I Your First?" },
      { property: "og:description", content: "A whispered love letter, written into eternity." },
